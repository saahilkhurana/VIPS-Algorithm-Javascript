//tealium universal tag - utag.498 ut4.0.201602242109, Copyright 2016 Tealium.com Inc. All Rights Reserved.
...
for(f=0;f<u.data.multicat_arr.length;f++){u.loader({"type":"iframe","src":u.data.base_url+'cat='+u.data.multicat_arr[f]+((c.length>0)?';'+c.join(u.data.qsp_delim):'')+'?',"loc":"body","id":'utag_498_iframe'});}}};utag.o[loader].loader.LOAD(id);}('498','pcln.main'));}catch(error){utag.DB(error);}
