	...
	function callEPSvcs() {
	    ...
	    if (typeof(tms_ep)!="undefined") {
	    	...
	    	try {
	     		//getScript('/svcs/ep/services/locale/v0/geoinfo?ipAddr=130.245.192.19, 130.245.192.19, 104.156.90.49, 130.245.192.19');
	     		 ajaxGet(updateEP);
	    	} catch (err) {
	    		if (typeof (console) != 'undefined')
					console.log("eperror:"+err);
	 ...
	 function ajaxGet(callback) {
		 ...
		 if(window.XMLHttpRequest) {
		  ...
		  if(req) {
		    ...
		    req.open("GET", "/svcs/ep/services/locale/v0/geoinfo?ipAddr=130.245.192.19, 130.245.192.19, 104.156.90.49, 130.245.192.19", true);
		    req.send();
		    return true;
		  }
		  } catch (e) {}
	...
	function processRules() {
		api.tagSwitches.TAG_CriteoOne='true';api.tagSwitches.TAG_OceanMedia='true';api.tagSwitches.TAG_Facebook='true';api.tagSwitches.TAG_Activity='true';api.tagSwitches.TAG_HotelCombined='true';api.tagSwitches.TAG_Triggit='true';api.tagSwitches.TAG_LiveRamp =('+US'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_HookLogic='true';api.tagSwitches.TAG_ValueClick='true';api.tagSwitches.TAG_RocketFuel='true';api.tagSwitches.TAG_Vindicosuite='true';api.tagSwitches.TAG_OwnerIQ =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_DblClickRetargeting='true';api.tagSwitches.TAG_GoogleHPA='true';api.tagSwitches.TAG_MSN='true';api.tagSwitches.TAG_AdRoll='true';api.tagSwitches.TAG_MediaAlpha='true';api.tagSwitches.TAG_Bridgetrack='true';api.tagSwitches.TAG_DblClickFloodlight='true';api.tagSwitches.TAG_LiveIntent='true';api.tagSwitches.PLATFORM_NEWSTACK='true';api.tagSwitches.TAG_BookingBuddy='true';api.tagSwitches.TAG_Conversant =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_BlueKai='false';api.tagSwitches.TAG_Nanigans='true';api.tagSwitches.TAG_OpenTable='true';api.tagSwitches.TAG_IntentMedia='true';api.tagSwitches.TAG_GoogleSmartPixel =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_YahooDot='true';api.tagSwitches.TAG_TripAdvisor='true';api.tagSwitches.TAG_ClickTripz='true';api.tagSwitches.TAG_Flashtalking='true';api.tagSwitches.TAG_RocketFuelRetargeting='true';api.tagSwitches.TAG_GPT='true';api.tagSwitches.TAG_Kayak='true';api.tagSwitches.TAG_AdWordsConversion='true';api.tagSwitches.TAG_Krux='true';api.tagSwitches.TAG_Sojern =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_SmarterTravel='true';api.tagSwitches.TAG_GlobalwideMedia='true';api.tagSwitches.TAG_Adelphic='true';api.tagSwitches.TAG_Twitter='true';api.tagSwitches.PLATFORM_P2='true';api.tagSwitches.TAG_Bing='true';api.tagSwitches.TAG_Steelhouse='false';api.tagSwitches.TAG_Taboola='true';api.tagSwitches.TAG_YahooPClick='true';api.tagSwitches.TAG_eXelate =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.PLATFORM_MOBILE='true';api.tagSwitches.TAG_Adara =('+US,CA'.indexOf(api.dataDictionary.clientCountryCode) > 0)+'';api.tagSwitches.TAG_AdMarketplace='true';api.tagSwitches.TAG_ComScore='true';api.tagSwitches.TAG_TVSquared='true';api.tagSwitches.TAG_Eyeview='true';api.tagSwitches.TAG_Amazon='true';
	}
