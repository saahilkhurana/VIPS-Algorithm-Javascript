	...
	function callEPSvcs() {
	    ...
	    if (typeof(tms_ep)!="undefined") {
	    	...
	    	try {
	     		//getScript('/svcs/ep/services/locale/v0/geoinfo?ipAddr=130.245.68.70, 130.245.68.70, 104.156.90.46, 130.245.68.70');
	     		 ajaxGet(updateEP);
	    	} catch (err) {
	    		if (typeof (console) != 'undefined')
					console.log("eperror:"+err);
	 ...
	 function ajaxGet(callback) {
		 ...
		 if(window.XMLHttpRequest) {
		  ...
		  if(req) {
		    ...
		    req.open("GET", "/svcs/ep/services/locale/v0/geoinfo?ipAddr=130.245.68.70, 130.245.68.70, 104.156.90.46, 130.245.68.70", true);
		    req.send();
		    return true;
		  }
		  } catch (e) {}
